const CACHE_NAME = 'attendance-v100';
const urlsToCache = [
  './index.html',
  './manifest.json',
...
self.addEventListener('install', (event) => {
  console.log('[SW] Installing Service Worker v100...');
  event.waitUntil(
...
self.addEventListener('activate', (event) => {
  console.log('[SW] Activating Service Worker v100...');
...
console.log('[SW] Service Worker v100 loaded');
